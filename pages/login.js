...
const LoginPage = () => {
  ...
  return (
    <>
      <Head>
        <title>Login - GYMX</title>
        <meta name="description" content="Inicia sesión en tu cuenta de GYMX." />
      </Head>
        ...
        >
          <div>
            ...
            <p className="mt-2 text-center text-sm text-text-secondary">
              ¿No tienes cuenta?{' '}
              <Link href="/signup" className="font-medium text-accent hover:text-red-700">
                Regístrate aquí
              </Link>
            </p>
          </div>
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            <div className="rounded-md shadow-sm -space-y-px">
              <div>
                ...
                <input id="email-address" name="email" type="email" autoComplete="email" required className="appearance-none rounded-none relative block w-full px-3 py-3 border border-gray-600 bg-primary placeholder-gray-500 text-white rounded-t-md focus:outline-none focus:ring-accent focus:border-accent focus:z-10 sm:text-sm" placeholder="Email" />
              </div>
              <div>
            ...
            <div className="flex items-center justify-between">
              <div className="text-sm">
                <a href="#" className="font-medium text-text-secondary hover:text-accent">
